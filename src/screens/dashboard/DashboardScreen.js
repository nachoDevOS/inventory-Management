...
function makeStyles(C) {
  return StyleSheet.create({
    ...
    sectionTitle: { fontSize:12, fontWeight:'700', color: C.text, marginBottom:8, marginTop:4 },
    statsGrid: { flexDirection:'row', flexWrap:'wrap', gap:10, marginBottom:14 },
    statCard: { borderRadius:12, padding:14, alignItems:'center', width:'47%', backgroundColor: C.card },
    statIcon: { fontSize:20, marginBottom:4 },
    statValue: { fontSize:14, fontWeight:'800' },
    statLabel: { fontSize:10, color: C.textLight, textAlign:'center', marginTop:2 },
    // Ganancia card
    gananciaCard: { backgroundColor: C.card, borderRadius:12, padding:16, marginBottom:14 },
    gananciaTitle: { fontSize:12, fontWeight:'700', color: C.text, marginBottom:12 },
    gananciaRow: { flexDirection:'row', alignItems:'center', justifyContent:'space-between' },
    gananciaItem: { alignItems:'center', flex:1 },
    gananciaLabel: { fontSize:10, color: C.textLight },
    gananciaValor: { fontSize:13, fontWeight:'800', marginTop:2 },
    gananciaOp: { fontSize:16, color: C.textLight, fontWeight:'300' },
    margenBadge: { backgroundColor:'#EFF6FF', borderRadius:8, padding:8, marginTop:10, alignItems:'center' },
    margenText: { fontSize:11, fontWeight:'700', color: C.primary },
    // Mes card
    ...
    mesValor: { fontSize:14, fontWeight:'800', color: C.primary },
    ...
    btnPDFText: { color:'#fff', fontWeight:'700', fontSize:11 },
    // Card
    ...
    topRank: { fontSize:15, fontWeight:'800', color: C.primary, width:32 },
    topNombre: { fontSize:11, fontWeight:'600', color: C.text },
    topSub: { fontSize:10, color: C.textLight, marginTop:1 },
    ...
    stockNombre: { fontSize:11, color: C.text, flex:1, marginRight:8 },
    ...
    ventaCliente: { fontSize:11, fontWeight:'600', color: C.text },
    ventaFecha: { fontSize:10, color: C.textLight, marginTop:2 },
    ventaTotal: { fontSize:13, fontWeight:'bold', color: C.success },
    // Empty
    empty: { alignItems:'center', paddingVertical:32, paddingHorizontal:16 },
    emptyTitle: { fontSize:13, fontWeight:'600', color: C.text, marginTop:14 },
    emptySub: { fontSize:11, color: C.textLight, textAlign:'center', marginTop:6, lineHeight:18 },
    // Licencia
    ...
    footerNegocio: { fontSize:13, fontWeight:'800', color: C.text, textAlign:'center' },
    footerDato: { fontSize:10, color: C.textLight, marginTop:4, textAlign:'center' },
    // Publicidad
    ...
    adLogoText: { color:'#fff', fontWeight:'900', fontSize:13 },
    adBrand: { fontSize:13, fontWeight:'800', color:'#fff' },
    adTagline: { fontSize:10, color:'#93C5FD', marginTop:2 },
    adDivider: { height:1, backgroundColor:'#1E3A5F', marginBottom:12 },
    adDesc: { fontSize:10, color:'#CBD5E1', lineHeight:16, marginBottom:12 },
    adFeatures: { flexDirection:'row', gap:8, flexWrap:'wrap', marginBottom:12 },
    adFeatureItem: { fontSize:10, color:'#93C5FD', backgroundColor:'#1E3A5F', paddingHorizontal:10, paddingVertical:4, borderRadius:20 },
    adFooter: { alignItems:'center' },
    adWeb: { fontSize:11, fontWeight:'700', color:'#60A5FA' },
  });
}
